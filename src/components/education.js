  ...
  return (
    <div id='education'>
      ...
      <div className='stdBox'>               
        <h1 className='programName'>IT Programmer-Analyst ASC<span className='date'>May 2023 - December 2024</span></h1>
      ...
      <div className='stdBox'>        
        <h1 className='programName'>Electromechanics Engineering<span className='date'>August 2016 - June 2021</span></h1>
